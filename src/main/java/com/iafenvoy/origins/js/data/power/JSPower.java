...
public class JSPower extends Power {
    private static final Map<String, Map<String, Consumer<OriginDataHolder>>> CALLBACKS = new ConcurrentHashMap<>();
    private static final Map<String, Predicate<OriginDataHolder>> IS_ACTIVE = new ConcurrentHashMap<>();
    ...
    public JSPower(BaseSettings settings, String callbackId) {
        super(settings);
    ...
    public void grant(@NotNull OriginDataHolder holder) {
        ...
        Consumer<OriginDataHolder> cb = m != null ? m.get("grant") : null;
        if (cb != null) try {
            cb.accept(holder);
        } catch (Exception e) {
    ...
    public void revoke(@NotNull OriginDataHolder holder) {
        var m = CALLBACKS.get(this.callbackId);
        Consumer<OriginDataHolder> cb = m != null ? m.get("revoke") : null;
        if (cb != null) try {
            cb.accept(holder);
        } catch (Exception e) {
    ...
    public void tick(@NotNull OriginDataHolder holder) {
        var m = CALLBACKS.get(this.callbackId);
        Consumer<OriginDataHolder> cb = m != null ? m.get("tick") : null;
        if (cb != null) try {
            cb.accept(holder);
        } catch (Exception e) {
    ...
    public boolean isActive(@NotNull OriginDataHolder holder) {
        Predicate<OriginDataHolder> cb = IS_ACTIVE.get(this.callbackId);
        if (cb != null) try {
            return cb.test(holder);
        } catch (Exception e) {
    ...
    public void active(@NotNull OriginDataHolder holder) {
        var m = CALLBACKS.get(this.callbackId);
        Consumer<OriginDataHolder> cb = m != null ? m.get("active") : null;
        if (cb != null) try {
            cb.accept(holder);
        } catch (Exception e) {
    ...
    public void inactive(@NotNull OriginDataHolder holder) {
        var m = CALLBACKS.get(this.callbackId);
        Consumer<OriginDataHolder> cb = m != null ? m.get("inactive") : null;
        if (cb != null) try {
            cb.accept(holder);
        } catch (Exception e) {
    ...
    private static void putCallback(String id, String type, Consumer<OriginDataHolder> cb) {
    ...
    public static final class PowerBuilder {
        ...
        private Consumer<OriginDataHolder> grant, revoke, tick, active, inactive;
        private Predicate<OriginDataHolder> isActive;

        private PowerBuilder(String id) {
            this.id = id;
        }

        public PowerBuilder grant(Consumer<OriginDataHolder> cb) {
            this.grant = cb;
            return this;
        }

        public PowerBuilder revoke(Consumer<OriginDataHolder> cb) {
            this.revoke = cb;
            return this;
        }

        public PowerBuilder tick(Consumer<OriginDataHolder> cb) {
            this.tick = cb;
            return this;
        }

        public PowerBuilder active(Consumer<OriginDataHolder> cb) {
            this.active = cb;
            return this;
        }

        public PowerBuilder inactive(Consumer<OriginDataHolder> cb) {
            this.inactive = cb;
            return this;
        }

        public PowerBuilder isActive(Predicate<OriginDataHolder> cb) {
            this.isActive = cb;
            return this;
        }
